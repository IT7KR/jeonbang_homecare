...
import { FileText, Upload, X, Loader2, Calendar } from "lucide-react";
...
export function ApplyStep3Details({ form }: ApplyStep3DetailsProps) {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // 최대 10장 제한
      const combined = [...currentPhotos, ...compressedFiles].slice(0, 10);
    ...
    <div className="space-y-6">
      ...
      <section className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <SeniorLabel htmlFor="preferredWorkDate" optional variant="primary">
              희망 작업일
            </SeniorLabel>
            <DatePicker
              date={
      ...
      <section className="space-y-5">
        ...
        <p className="text-[14px] text-gray-500">
          현장 사진을 첨부하시면 더 정확한 상담이 가능합니다. (최대 10장)
        </p>
