...
const FAQ_DATA: FAQItem[] = [
  ...
  // 파트너 관련
  {
    ...
    answer:
      "홈페이지의 '파트너 등록' 버튼을 클릭하여 업체 정보, 서비스 가능 분야, 활동 지역 등을 입력해주세요. 심사 후 승인되면 SMS로 안내드립니다.",
  },
  {
    category: "파트너",
    question: "파트너 등록 심사 기간은 얼마나 걸리나요?",
    answer:
      "일반적으로 영업일 기준 1-3일 내에 심사가 완료됩니다. 심사 결과는 SMS로 안내드립니다.",
  },
  {
    category: "파트너",
    question: "파트너 수수료는 어떻게 되나요?",
    answer:
      "파트너 수수료 및 정산 방식은 별도로 안내드립니다. 자세한 내용은 파트너 등록 후 담당자와 상담해주세요.",
  },
  // 기타
  {
    category: "기타",
...
const CATEGORIES = ["전체", "서비스 이용", "파트너", "기타"];
